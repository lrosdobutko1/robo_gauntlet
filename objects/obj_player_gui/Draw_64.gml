...
var t = player.current_shields / player.max_shields;

// slow near full, fast near empty
t = power(t, 0.75); // try 2–4

shield_bar_color = make_colour_rgb(
    max_color * (1 - t),
    max_color * t,
    max_color * t
);

set_gradient_shader(bar, shield_bar_color, c_white, 1);
